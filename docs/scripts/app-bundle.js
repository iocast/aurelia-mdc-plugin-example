...
define('resources/index',['exports', 'aurelia-pal'], function (exports, _aureliaPal) {
    ...
    function configure(config) {
        config.globalResources([_aureliaPal.PLATFORM.moduleName('./elements/au-code'), _aureliaPal.PLATFORM.moduleName('./elements/code-tabs')]);
    }
});
define('resources/elements/code-tabs',['exports', 'material-components-web'], function (exports, _materialComponentsWeb) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.CodeTabs = undefined;
    ...
    var CodeTabs = exports.CodeTabs = function () {
        ...
        CodeTabs.prototype.updateTab = function updateTab(idx) {
            var activePanel = this.codePanels.querySelector(".code-tab-panel.is-active");
...
define('components/switches',["exports"], function (exports) {
  "use strict";
  ...
  var Switches = exports.Switches = function Switches() {
    _classCallCheck(this, Switches);
  };
});
define('text!components/switches.html', ['module'], function(module) { module.exports = "<template></template>\n    <div class=\"mdc-switch\">\n        <input type=\"checkbox\" id=\"basic-switch\" class=\"mdc-switch__native-control\" role=\"switch\">\n        <div class=\"mdc-switch__background\">\n            <div class=\"mdc-switch__knob\"></div>\n        </div>\n    </div>\n    <label for=\"basic-switch\">off/on</label>\n</template>\n"; });
